...
So for this case design, I added the option to reuse the holes in the switch plate that were originally intended to secure the case together to mount the PCB and the switch plate. These holes are of 5mm diameter, the same as most m2 washers. Therefore, I designed a custom 6.5mm outer diameter washer that I could 3D print. It looks like this.
